...
final class Constants {
	...
	static final int FOLGENLAENGE		= 10;		// Anzahl der zu sortierenden Schluessel
	static final int MEMSORT_BUFFER		= 2;		// Anzahl der Schluessel die gleichzeitig 
													// in den Speicher geladen werden
	static final int SCHLUESSELGROESSE	= 4;		// Lanege eines Schluessels in Bytes
	static final int READ_BUFFER		= MEMSORT_BUFFER/2;
