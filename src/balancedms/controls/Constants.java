...
public final class Constants {
	...
	public static final int FOLGENLAENGE		= 23;		// Anzahl der zu sortierenden Schluessel
	...
	public static final int READ_BUFFER			= 4;//MEMSORT_BUFFER / 4;
	public static final int WRITE_BUFFER		= 4;//MEMSORT_BUFFER / 2;
}